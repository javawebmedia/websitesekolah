      ...
      <div class="container pt-12 pt-md-14 pb-13 pb-md-15">
        ...
        <div class="row grid-view gx-md-8 gx-xl-10 gy-8 gy-lg-0">
         ...
         <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              <img src="<?php echo base_url('assets/upload/image/'.$ekstrakurikuler->gambar) ?>" class="img img-thumbnail">
            </div>
          </div>
         </div>
         <div class="col-md-8">
       ...
       <!--/.row -->
        <div class="row grid-view gx-md-8 gx-xl-10 gy-8 gy-lg-0 mt-5 justify-content-center">
          <div class="col-xl-12">
            <h3 class="text-center mt-5 mb-5">Lihat Ekstrakurikuler dan Penghargaan Lainnya....</h3>
          </div>
           <?php $no=1; foreach($ekstrakurikuler_list as $ekstrakurikuler) { ?>
