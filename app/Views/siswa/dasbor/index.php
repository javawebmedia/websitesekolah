<div class="alert alert-info">
	<p>Hai <strong><em><?php echo $siswa['nama_lengkap'] ?> (NISN: <?php echo $siswa['nisn'] ?>)</em></strong>. Selamat datang di website <?php echo namaweb() ?></p>
	<hr>
	<p><strong><i class="fa fa-exclamation"></i> Security Warning: </strong>
		<?php if(sha1($siswa['nisn'])==$siswa['password']) { ?>
			<span  class="text-warning">Anda sebaiknya segera mengganti password</span>
		<?php }else{ ?>
			Password Anda telah diupdate
		<?php } ?>
		. Untuk mengganti password klik <a href="<?php echo base_url('siswa/akun') ?>">Update akun.</a>
	</p>
</div>
