...
<div class="form-group row">
	...
	<div class="col-sm-9">
      <select name="status_harga_produk" class="form-control select2">
      	...
      	<option value="Tutup" <?php if($harga_produk->status_harga_produk=="Tutup") { echo "selected"; } ?>>Tutup</option>
      	<option value="Booked" <?php if($harga_produk->status_harga_produk=="Booked") { echo "selected"; } ?>>Sudah dibooking (Booked)</option>
      	<option value="Batal" <?php if($harga_produk->status_harga_produk=="Batal") { echo "selected"; } ?>>Batal</option>
      </select>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-sm-4">
      <input type="text" name="tanggal_mulai" id="tanggal_mulai" class="form-control tanggal" placeholder="dd-mm-yyyy" value="<?php echo date('d-m-Y',strtotime($harga_produk->tanggal_mulai)) ?>">
...
<div class="form-group row">
	...
	<div class="col-sm-4">
      <input type="text" name="tanggal_selesai" id="tanggal_selesai" class="form-control tanggal" placeholder="dd-mm-yyyy" value="<?php echo date('d-m-Y',strtotime($harga_produk->tanggal_selesai)) ?>">
