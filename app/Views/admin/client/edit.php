...
<div class="form-group row">
	...
	<div class="col-md-3">
		<select name="jenis_client" class="form-control">
			...
			<option value="Perorangan" <?php if($client->jenis_client=='Perorangan') { echo 'selected'; } ?>>Perorangan</option>
			<option value="Pemerintahan" <?php if($client->jenis_client=='Pemerintahan') { echo 'selected'; } ?>>Pemerintahan</option>
		</select>
	...
	<div class="col-md-3">
		<select name="status_client" class="form-control">
			...
			<option value="Draft" <?php if($client->status_client=='Draft') { echo 'selected'; } ?>>Unpublished</option>
		</select>
...
<div class="form-group row">
	...
	<div class="col-md-1">
		<?php if($client->gambar=="") { }else{ ?>
			<img src="<?php echo base_url('assets/upload/image/'.$client->gambar) ?>" class="img img-thumbnail">
		<?php } ?>
	</div>
</div>
