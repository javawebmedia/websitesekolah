	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a href="<?php echo base_url('admin/portfolio/edit/'.$portfolio->id_portfolio) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
				<a href="<?php echo base_url('admin/portfolio/delete/'.$portfolio->id_portfolio) ?>" class="btn btn-dark btn-sm" onclick="confirmation(event)"><i class="fa fa-trash"></i></a>
			</td>
		</tr>
		<?php $no++; } ?>
	</tbody>
