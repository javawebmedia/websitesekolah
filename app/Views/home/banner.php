<section class="wrapper bg-light">
  <div class="container-card">
    <div class="card image-wrapper bg-full bg-image bg-overlay bg-overlay-light-500 mt-2 mb-0" data-image-src="<?php echo $this->website->banner() ?>">
        ...
        <div class="container">
          <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center text-center text-lg-start">
            <div class="col-lg-7" data-cues="slideInDown" data-group="page-title" data-delay="900">
              <h1 class="display-4 mb-4 me-xl-5 me-xxl-0"><?php echo $slider->judul_galeri ?></h1>
              <p class="lead fs-23 lh-sm mb-7 pe-xxl-15"><?php echo strip_tags($slider->isi) ?></p>
