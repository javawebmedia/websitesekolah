    ...
    <div class="row gx-0 gy-10 align-items-center">
      ...
      <div class="col-lg-5 offset-lg-1" data-cues="slideInDown">
        <div class="position-relative">
          ...
          <figure class="rounded shadow-lg"><img src="<?php echo base_url('assets/upload/image/'.$video->gambar) ?>" srcset="<?php echo base_url('assets/upload/image/'.$video->gambar) ?> 2x" alt=""></figure>
        </div>
        <!-- /div -->
      </div>
      <!-- /column -->
